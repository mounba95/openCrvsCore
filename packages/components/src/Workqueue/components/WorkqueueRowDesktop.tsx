...
// Niger : lignes alternées vert pâle/blanc + texte vert, couleurs exactes
// reprises d'INCI (--table-row-even-bg-color/--table-row-odd-bg-color/
// --table-row-text-color, fournies par l'utilisateur le 2026-08-18) au
// lieu du blanc uni + texte noir par défaut.
