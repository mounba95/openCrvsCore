...
const ItemContainer = styled.button<{ isSelected?: boolean }>`
  ...
  border-radius: 4px;
  padding: 0 8px;
  /* Niger : transparent au lieu de blanc quand non sélectionné — se fond
     dans le fond vert pâle du menu (voir LeftNavigation.tsx) plutôt que
     de créer une pastille blanche par élément. */
  background-color: ${({ theme, isSelected }) =>
    isSelected ? theme.colors.brandGreenLight : 'transparent'};
