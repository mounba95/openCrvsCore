...
// Niger : mêmes couleurs vertes que Workqueue.tsx (en-têtes, lignes
// alternées) — ce composant Table (générique, utilisé par le Registre, les
// Statistiques, l'historique d'acte...) n'était pas encore couvert par ce
// traitement (signalé par l'utilisateur le 2026-08-18).
