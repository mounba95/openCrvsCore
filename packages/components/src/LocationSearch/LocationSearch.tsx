...
export interface ILocationSearchComponentProps {
...
export class LocationSearch extends React.Component<
  ILocationSearchComponentProps,
  IState
> {
  searchTimeout: NodeJS.Timeout | undefined
  constructor(props: ILocationSearchComponentProps) {
    super(props)
    this.state = {
  ...
  componentDidUpdate(prevProps: ILocationSearchComponentProps) {
