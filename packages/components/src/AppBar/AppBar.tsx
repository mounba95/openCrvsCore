...
// Niger : bandeau vert plein (comme le menu de gauche et les panneaux),
// couleur exacte reprise d'INCI (--header-bg-color, capture fournie le
// 2026-08-18) — remplace le fond blanc par défaut. Texte blanc par défaut
// (voir Title ci-dessous) pour rester lisible sur ce fond.
const AppBarWrapper = styled.div`
  display: flex;
  flex-direction: column;
  width: 100%;
  background: #31cc67;
  border-top: 4px solid ${({ theme }) => theme.colors.brandGreenDark};
