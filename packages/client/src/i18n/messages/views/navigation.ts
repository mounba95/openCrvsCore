...
interface INavigationMessages
  ...
  registers: MessageDescriptor
  'declaration-deadlines': MessageDescriptor
...
const messagesToDefine: INavigationMessages = {
  ...
  registers: {
    ...
    description: 'Registers label in navigation',
    id: 'navigation.registers'
  },
  'declaration-deadlines': {
    defaultMessage: 'Délais de déclaration',
    description: 'Declaration deadlines label in navigation',
    id: 'navigation.declarationDeadlines'
  },
  config: {
