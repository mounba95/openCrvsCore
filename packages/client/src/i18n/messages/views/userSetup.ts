...
interface IUserSetupMessages
  ...
  changeOfficeTitle: MessageDescriptor
  changeOfficeMessage: MessageDescriptor
  changeOfficeMenuItem: MessageDescriptor
...
const messagesToDefine: IUserSetupMessages = {
  ...
  changeOfficeTitle: {
    defaultMessage: 'Change active office',
    description: 'Title for the active-office switch modal',
    id: 'user.profile.changeOfficeTitle'
  },
  changeOfficeMessage: {
    defaultMessage: 'Choose which of your assigned offices you want to work in.',
    description: 'Body text for the active-office switch modal',
    id: 'user.profile.changeOfficeMessage'
  },
  changeOfficeMenuItem: {
    defaultMessage: 'Change office',
    description: 'Label for the active-office switch item in the profile menu',
    id: 'user.profile.changeOfficeMenuItem'
  },
  phoneNumber: {
