...
// Niger : l'auto-désassignation de soi-même n'a plus de déclencheur manuel
// (elle se produit automatiquement après chaque action, voir CONTEXTE-PROJET.md)
// — cette modale ne sert plus qu'au déblocage d'un acte assigné à quelqu'un
// d'autre (OEC/admin, scope `record.unassign-others`).
