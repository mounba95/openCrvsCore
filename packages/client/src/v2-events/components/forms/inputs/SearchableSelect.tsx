...
/**
 * Niger : même correctif que `@opencrvs/components/lib/Select` — le menu
 * est rendu via un portail (document.body) pour ne plus être masqué par une
 * carte/conteneur voisin (ex: OfficesPicker dans le formulaire de création
 * d'utilisateur). Voir Select.tsx pour le détail.
 */
  ...
  return (
    <>
      ...
      <StyledAsyncSelect
        ...
        // Niger : rendu du menu via portail — voir GlobalReactSelectMenuStyle.
        menuPortalTarget={document.body}
        placeholder={
          placeholder ?? intl.formatMessage(formMessages.formSelectPlaceholder)
        }
        touched={touched}
        value={value}
        onBlur={onBlur}
