...
// Niger : l'assignation manuelle a été retirée (assignation automatique et
// silencieuse à l'ouverture) — seul `UNASSIGN` reste comme action de menu,
// réservé au déblocage OEC/admin d'un acte détenu par quelqu'un d'autre.
