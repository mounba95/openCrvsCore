...
// Niger : fond vert pâle + liseré vert en haut, comme le reste des cartes
// de formulaire (voir AccentContent dans FormWizard.tsx) — la page de
// détail/récapitulatif était restée blanche (signalé par l'utilisateur le
// 2026-08-18).
