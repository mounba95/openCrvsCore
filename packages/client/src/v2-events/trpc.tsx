...
import { getActiveOfficeOverride } from '@client/v2-events/hooks/useActiveOffice'
      ...
      links: [
        ...
        httpLink({
          ...
          async headers() {
            ...
            const activeOfficeId = getActiveOfficeOverride()
            return {
              authorization: `Bearer ${getToken()}`,
              ...(activeOfficeId && { 'x-active-office-id': activeOfficeId })
            }
          }
        })
      ]
