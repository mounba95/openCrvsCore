...
--
-- Name: user_offices; Type: TABLE; Schema: app; Owner: events_migrator
--

CREATE TABLE app.user_offices (
    user_id uuid NOT NULL,
    office_id uuid NOT NULL
);


ALTER TABLE app.user_offices OWNER TO events_migrator;
...
--
-- Name: user_offices user_offices_pkey; Type: CONSTRAINT; Schema: app; Owner: events_migrator
--

ALTER TABLE ONLY app.user_offices
...
--
-- Name: user_offices_office_id_idx; Type: INDEX; Schema: app; Owner: events_migrator
--

CREATE INDEX user_offices_office_id_idx ON app.user_offices USING btree (office_id);
...
--
-- Name: user_offices user_offices_office_id_fkey; Type: FK CONSTRAINT; Schema: app; Owner: events_migrator
--

ALTER TABLE ONLY app.user_offices
    ADD CONSTRAINT user_offices_office_id_fkey FOREIGN KEY (office_id) REFERENCES app.locations(id);


--
-- Name: user_offices user_offices_user_id_fkey; Type: FK CONSTRAINT; Schema: app; Owner: events_migrator
--

ALTER TABLE ONLY app.user_offices
    ADD CONSTRAINT user_offices_user_id_fkey FOREIGN KEY (user_id) REFERENCES app.users(id);
...
--
-- Name: TABLE user_offices; Type: ACL; Schema: app; Owner: events_migrator
--

GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE app.user_offices TO events_app;
