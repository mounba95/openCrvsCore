...
export const ApplicationConfig = z.object({
  ...
  /**
   * Niger : 'none' désactive complètement l'envoi de notifications de
   * cycle de vie du compte (création, réinitialisation de mot de passe,
   * rappel d'identifiant, changement de téléphone/e-mail...) — la
   * majorité des agents n'ont pas d'adresse e-mail, et l'administrateur
   * communique désormais les mots de passe directement. Voir
   * CONTEXTE-PROJET.md.
   */
  USER_NOTIFICATION_DELIVERY_METHOD: z.enum(['email', 'sms', 'none']),
